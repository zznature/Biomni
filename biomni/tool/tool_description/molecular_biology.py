description = [{'description': 'Find all Open Reading Frames (ORFs) in a DNA sequence using '
  ...
  'optional_parameters': [{'default': False,
                           'description': 'Whether to search the reverse '
                                          'complement strand',
                           'name': 'search_reverse',
                           'type': 'bool'},
                          {'default': False,
                           'description': 'Whether to filter out ORFs with '
                                          'same end but later start',
                           'name': 'filter_subsets',
                           'type': 'bool'}],
 ...
 {'description': 'Unified function to retrieve plasmid sequences from either '
  ...
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Either an Addgene ID or plasmid '
                                          'name',
                           'name': 'identifier',
                           'type': 'str'}]},
 ...
 {'description': 'Simulate PCR amplification with given primers and sequence.',
  ...
  'optional_parameters': [{'default': False,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Either a sequence string or path to '
                                          'plasmid file',
                           'name': 'sequence',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Simulates restriction enzyme digestion of a DNA sequence and '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Names of restriction enzymes to use '
                                          'for digestion',
                           'name': 'enzyme_names',
                           'type': 'List[str]'}]},
 {'description': 'Identifies restriction enzyme sites in a given DNA sequence '
                 'for specified enzymes.',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'List of restriction enzyme names to '
                                          'check',
                           'name': 'enzymes',
                           'type': 'List[str]'}]},
 {'description': 'Finds common restriction enzyme sites in a DNA sequence and '
                 'returns their cut positions.',
 ...
 {'description': 'Compare query sequence against reference sequence to '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'The reference sequence to compare '
                                          'against',
 ...
 {'description': 'Design sgRNAs for CRISPR knockout by searching pre-computed '
  ...
  'optional_parameters': [{'default': 'human',
                          ...
                          {'default': 1,
                           ...
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'Target gene symbol/name (e.g., '
                                          '"EGFR", "TP53")',
                           'name': 'gene_name',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Return a customized protocol for Golden Gate assembly based '
  ...
  'optional_parameters': [{'default': 1,
                          ...
                          {'default': False,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Type IIS restriction enzyme to be '
                                          'used',
                           'name': 'enzyme_name',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Length of the destination vector in '
                                          'bp',
                           'name': 'vector_length',
                           'type': 'int'}]},
 {'description': 'Return a standard protocol for bacterial transformation.',
  ...
  'optional_parameters': [{'default': 'ampicillin',
                           ...
                           'type': 'str'},
                          {'default': False,
                           'description': 'Whether the sequence contains '
                                          'repetitive elements',
                           'name': 'is_repetitive',
                           'type': 'bool'}],
  'required_parameters': []},
 {'description': 'Design a single primer within the given sequence window.',
  ...
  'optional_parameters': [{'default': 20,
                          ...
                          {'default': 65.0,
                           ...
                           'type': 'float'},
                          {'default': 100,
                           'description': 'Size of window to search for '
                                          'primers',
                           'name': 'search_window',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Design Sanger sequencing primers to verify a specific region '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'List of existing primers with their '
                                          'sequences and optional names',
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'},
                          {'default': 800,
                           'description': 'Typical read length for each primer '
                                          'in base pairs',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Start and end positions to verify '
                                          '(0-based indexing)',
                           'name': 'target_region',
                           'type': 'Tuple[int, int]'}]},
 {'description': 'Design complementary oligonucleotides with Type IIS '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Sequence to be inserted (e.g., '
