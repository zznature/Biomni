description = [{'description': 'Quantify the percentage of cells in each cell cycle phase '
  ...
  'required_parameters': [{'default': None,
                           'description': 'List of file paths to microscopy '
 ...
 {'description': 'Quantify cell motility features from time-lapse microscopy '
  ...
  'optional_parameters': [{'default': './results',
                           ...
                           'type': 'str'},
                          {'default': 3,
                           'description': 'Number of motility pattern clusters '
                                          'to identify',
                           'name': 'num_clusters',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to directory containing '
                                          'time-lapse microscopy images in '
                                          'sequential order',
 ...
 {'description': 'Performs Fluorescence-Activated Cell Sorting (FACS) to '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 'sorted_cells.csv',
                           'description': 'Filename to save the sorted cell '
                                          'population data',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'The fluorescence parameter to use '
                                          "for sorting (e.g., 'GFP', 'FITC', "
                                          "'PE')",
 ...
 {'description': 'Analyze flow cytometry data to identify and quantify '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'Spillover/compensation matrix to '
