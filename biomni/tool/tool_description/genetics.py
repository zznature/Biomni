description = [{'description': 'Perform liftover of genomic coordinates between hg19 and '
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'int'},
                          {'default': None,
                           'description': "Input genome build ('hg19' or "
                                          "'hg38')",
                           'name': 'input_format',
                           'type': 'str'},
                          {'default': None,
                           'description': "Output genome build ('hg19' or "
                                          "'hg38')",
                           'name': 'output_format',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Performs Bayesian fine-mapping from GWAS summary statistics '
  ...
  'optional_parameters': [{'default': 5000,
                           'description': 'Number of training iterations for '
                                          'the variational inference algorithm',
                           'name': 'n_iterations',
                           'type': 'int'},
                          {'default': 0.01,
                           'description': 'Learning rate for the optimization '
                                          'algorithm',
                           'name': 'learning_rate',
                           'type': 'float'},
                          {'default': 64,
                           'description': 'Hidden dimension size for the '
                                          'neural network',
                           'name': 'hidden_dim',
                           'type': 'int'},
                          {'default': 0.95,
                           'description': 'Threshold for defining the credible '
                                          'set (e.g., 0.95 for a 95% credible '
                                          'set)',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Linkage disequilibrium matrix with '
                                          'pairwise correlations between '
                                          'variants',
                           'name': 'ld_matrix',
                           'type': 'numpy.ndarray'}]},
 {'description': 'Analyzes and categorizes mutations induced by Cas9 at target '
                 'sites.',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Dictionary mapping sequence IDs to '
                                          'reference DNA sequences (strings)',
                          ...
                          {'default': None,
                           ...
                           'type': 'dict'}]},
 {'description': 'Analyzes CRISPR-Cas9 genome editing results by comparing '
                 'original and edited sequences.',
  'name': 'analyze_crispr_genome_editing',
  'optional_parameters': [{'default': None,
                           'description': 'The homology-directed repair '
                                          'template sequence, if used',
                           'name': 'repair_template',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'The original DNA sequence before '
                                          'CRISPR-Cas9 editing',
                           'name': 'original_sequence',
                           'type': 'str'},
                          {'default': None,
                           'description': 'The DNA sequence after CRISPR-Cas9 '
                                          'editing',
                           'name': 'edited_sequence',
                           'type': 'str'},
                          {'default': None,
                           'description': 'The CRISPR guide RNA (crRNA) '
                                          'sequence used for targeting',
                           'name': 'guide_rna',
                           'type': 'str'}]},
 {'description': 'Simulate DNA sequences with specified demographic and '
                 'coalescent histories using msprime.',
  'name': 'simulate_demographic_history',
  'optional_parameters': [{'default': 10,
                           'description': 'Number of sample sequences to '
                                          'simulate',
                           'name': 'num_samples',
                           'type': 'int'},
                          {'default': 100000,
                           'description': 'Length of the simulated sequence in '
                                          'base pairs',
                          ...
                          {'default': 'constant',
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Parameters specific to the chosen '
                                          'demographic model',
                          ...
                          {'default': 'simulated_sequences.vcf',
                           'description': 'Filename to save the simulated '
                                          'sequences in VCF format',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': []},
 {'description': 'Identifies binding sites for a specific transcription factor '
                 'in a genomic sequence.',
  'name': 'identify_transcription_factor_binding_sites',
  'optional_parameters': [{'default': 0.8,
                           'description': 'Minimum score threshold for '
                                          'reporting binding sites (0.0-1.0)',
                           'name': 'threshold',
                           'type': 'float'},
                          {'default': None,
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Name of the transcription factor to '
                                          "search for (e.g., 'Hsf1', 'GATA1')",
                           'name': 'tf_name',
                           'type': 'str'}]},
 {'description': 'Fit a linear mixed model for genomic prediction using '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 'additive',
                           'description': 'Type of genetic model to fit: '
                                          '"additive" or "additive_dominance".',
                           'name': 'model_type',
                           'type': 'str'},
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'numpy.ndarray'},
                          {'default': None,
                           'description': 'Vector or matrix of phenotype data, '
                                          'with individuals in rows and traits '
                                          'in columns.',
                           'name': 'phenotypes',
                           'type': 'numpy.ndarray'}]},
 {'description': 'Performs PCR amplification of a target transgene and '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'Forward primer sequence. If not '
                                          'provided, will be designed based on '
                                          'target_region',
                           'name': 'forward_primer',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Reverse primer sequence. If not '
                                          'provided, will be designed based on '
                                          'target_region',
                           'name': 'reverse_primer',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Tuple of (start, end) positions for '
                                          'the target region in the genomic '
                                          'DNA',
                           'name': 'target_region',
                           'type': 'tuple'},
                          {'default': 58,
                          ...
                          {'default': 'pcr_result',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to file containing genomic DNA '
                                          'sequence in FASTA format or the '
                                          'sequence itself',
                           'name': 'genomic_dna',
                           'type': 'str'}]},
 {'description': 'Perform phylogenetic analysis on a set of protein sequences. '
  ...
  'optional_parameters': [{'default': './',
                          ...
                          {'default': 'clustalw',
                           ...
                           'type': 'str'},
                          {'default': 'fasttree',
                           'description': 'Method for tree construction: '
                                          '"iqtree" or fallback to '
                                          'neighbor-joining',
                           'name': 'tree_method',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
