description = [{'description': 'Engineer a bacterial genome by integrating therapeutic '
                 'genetic parts for therapeutic delivery.',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to the file containing the '
                                          'bacterial genome sequence in FASTA '
                                          'format',
                          ...
                          {'default': None,
                           ...
                           'name': 'genetic_parts',
                           'type': 'dict'}]},
 {'description': 'Analyze bacterial growth data and extract growth parameters '
                 'from OD600 measurements.',
  'name': 'analyze_bacterial_growth_rate',
  'optional_parameters': [{'default': 'Unknown strain',
                           'description': 'Name of the bacterial strain being '
                                          'analyzed',
                           'name': 'strain_name',
                           'type': 'str'},
                          {'default': './',
                           'description': 'Directory where to save the output '
                                          'files',
                           'name': 'output_dir',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Time points at which OD600 '
                                          'measurements were taken (in hours)',
                           'name': 'time_points',
                           'type': 'List or numpy.ndarray'},
                          {'default': None,
                           'description': 'Optical density (OD600) '
                                          'measurements corresponding to each '
                                          'time point',
                           'name': 'od_measurements',
                           'type': 'List or numpy.ndarray'}]},
 {'description': 'Analyze sequencing data to extract, quantify and determine '
                 'lineage relationships of barcodes.',
  'name': 'analyze_barcode_sequencing_data',
  'optional_parameters': [{'default': None,
                           'description': 'Regular expression pattern to '
                                          'identify barcodes. If None, will '
                                          'use flanking sequences',
                           'name': 'barcode_pattern',
                           'type': 'str'},
                          {'default': None,
                           'description': "5' flanking sequence of the barcode "
                                          'region',
                           'name': 'flanking_seq_5prime',
                           'type': 'str'},
                          {'default': None,
                           'description': "3' flanking sequence of the barcode "
                                          'region',
                           'name': 'flanking_seq_3prime',
                           'type': 'str'},
                          {'default': 5,
                           'description': 'Minimum count threshold for '
                                          'considering a barcode',
                           'name': 'min_count',
                           'type': 'int'},
                          {'default': './results',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the input sequencing file '
                                          'in FASTQ or FASTA format',
                           'name': 'input_file',
                           'type': 'str'}]},
 {'description': 'Performs bifurcation analysis on a dynamical system and '
                 'generates a bifurcation diagram.',
  'name': 'analyze_bifurcation_diagram',
  'optional_parameters': [{'default': 'Dynamical System',
                           'description': 'Name of the dynamical system being '
                                          'analyzed, used for plot titles.',
                           'name': 'system_name',
                           'type': 'str'},
                          {'default': './',
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'numpy.ndarray'}]},
 {'description': 'Generate a mathematical model of a biochemical network in '
                 'SBML format.',
  'name': 'create_biochemical_network_sbml_model',
  'optional_parameters': [{'default': 'biochemical_model.xml',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'List[dict]'},
                          {'default': None,
                           'description': 'Dictionary mapping reaction IDs to '
                                          'kinetic law parameters with '
                                          'law_type and parameters',
 ...
 {'description': 'Analyzes and optimizes a DNA/RNA sequence for improved '
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'dict'}]},
 {'description': 'Simulate gene regulatory circuit dynamics with growth '
                 'feedback.',
 ...
 {'description': 'Identifies functional domains within a Fatty Acid Synthase '
  ...
  'optional_parameters': [{'default': 'protein',
                           'description': 'Type of sequence provided - '
                                          '"protein" or "nucleotide"',
                           'name': 'sequence_type',
                           'type': 'str'},
                          {'default': 'fas_domains_report.txt',
                           'description': 'Name of the output file to save the '
                                          'detailed domain report',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'The nucleotide or protein sequence '
                                          'of a FAS gene',
                           'name': 'sequence',
                           'type': 'str'}]}]
