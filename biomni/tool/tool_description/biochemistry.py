description = [{'description': 'Analyzes circular dichroism (CD) spectroscopy data to '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'Temperature values (°C) for thermal '
                                          'denaturation experiment',
                           'name': 'temperature_data',
                           'type': 'list or numpy.ndarray'},
                          {'default': None,
                           'description': 'CD signal values at specific '
                                          'wavelength across different '
                                          'temperatures',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Name of the biomolecule sample '
                                          '(e.g., "Znf706", "G-quadruplex")',
                           'name': 'sample_name',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Type of biomolecule ("protein" or '
                                          '"nucleic_acid")',
                           'name': 'sample_type',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Wavelength values in nm for CD '
                                          'spectrum',
                          ...
                          {'default': None,
                           ...
                           'name': 'cd_signal_data',
                           'type': 'list or numpy.ndarray'}]},
 {'description': 'Calculate numeric values for various structural features of '
 ...
 {'description': 'Analyze protease kinetics data from fluorogenic peptide '
  ...
  'optional_parameters': [{'default': 'protease_kinetics',
                          ...
                          {'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Array of time points (in seconds) '
                          ...
                          {'default': None,
                           ...
                           'type': 'numpy.ndarray'},
                          {'default': None,
                           'description': 'Concentration of the protease '
                                          'enzyme (in μM)',
 ...
 {'description': 'Performs in vitro enzyme kinetics assay and analyzes the '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Name of the purified enzyme being '
                                          'tested',
                           'name': 'enzyme_name',
                           'type': 'str'},
                          {'default': None,
                           'description': 'List of substrate concentrations in '
                                          'μM for kinetic analysis',
                           'name': 'substrate_concentrations',
                           'type': 'list or numpy.ndarray'},
                          {'default': None,
 ...
 {'description': 'Analyzes isothermal titration calorimetry (ITC) data to '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'numpy.ndarray'},
                          {'default': 298.15,
                           'description': 'Temperature in Kelvin at which the '
                                          'experiment was conducted.',
                           'name': 'temperature',
                           'type': 'float'},
                          {'default': None,
                           'description': 'Initial concentration of protein in '
                                          'the cell in molar (M).',
                           'name': 'protein_concentration',
                           'type': 'float'},
                          {'default': None,
                           'description': 'Concentration of ligand in the '
                                          'syringe in molar (M).',
 ...
 {'description': 'Perform multiple sequence alignment and phylogenetic '
  ...
  'optional_parameters': [{'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'List of protein sequences in FASTA '
                                          'format from multiple organisms.',
