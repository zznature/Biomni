description = [{'description': 'Predicts intrinsically disordered regions (IDRs) in a '
                 'protein sequence using IUPred2A.',
  'name': 'predict_protein_disorder_regions',
  'optional_parameters': [{'default': 0.5,
                           'description': 'The disorder score threshold above '
                                          'which a residue is considered '
                                          'disordered',
                           'name': 'threshold',
                           'type': 'float'},
                          {'default': 'disorder_prediction_results.csv',
                           'description': 'Filename to save the per-residue '
                                          'disorder scores',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'The amino acid sequence of the '
                                          'protein to analyze',
 ...
 {'description': 'Quantifies cell morphology and cytoskeletal organization '
  ...
  'optional_parameters': [{'default': './results',
                           ...
                           'type': 'str'},
                          {'default': 'otsu',
                           'description': 'Method for cell segmentation '
 ...
 {'description': 'Quantify tissue deformation and flow dynamics from '
  ...
  'optional_parameters': [{'default': 'results',
                           ...
                           'type': 'str'},
                          {'default': 1.0,
                           'description': 'Physical scale of pixels (e.g., '
                                          'μm/pixel) for proper scaling of '
                                          'metrics',
                           'name': 'pixel_scale',
                           'type': 'float'}],
  'required_parameters': [{'default': None,
