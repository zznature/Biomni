description = [{'description': 'Perform ATAC-seq peak calling and differential accessibility '
                 'analysis using MACS2.',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to the treatment condition BAM '
                                          'file with aligned ATAC-seq reads',
                           'name': 'treatment_bam',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the control condition BAM '
                                          'file with aligned ATAC-seq reads',
                           'name': 'control_bam',
                           'type': 'str'}]},
 {'description': 'Analyzes bacterial growth curve data to determine growth '
  ...
  'optional_parameters': [{'default': '.',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Time points of measurements in '
                                          'hours',
                           'name': 'time_points',
 ...
 {'description': 'Simulates the isolation and purification of immune cells '
  ...
  'optional_parameters': [{'default': 'collagenase',
                          ...
                          {'default': 45,
                           ...
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'The type of tissue sample (e.g., '
                                          "'adipose', 'kidney', 'liver', "
                                          "'lung', 'spleen')",
                           'name': 'tissue_type',
                           'type': 'str'},
                          {'default': None,
                           'description': 'The immune cell population to '
                                          "isolate (e.g., 'macrophages', "
                                          "'leukocytes', 'T cells')",
 ...
 {'description': 'Estimate cell cycle phase durations using dual-nucleoside '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'dict'},
                          {'default': None,
                           'description': 'Initial estimates for cell cycle '
                                          'phase durations and death rates',
                           'name': 'initial_estimates',
                           'type': 'dict'}]},
 {'description': 'Track immune cells under flow conditions and classify their '
                 'behaviors.',
  ...
  'optional_parameters': [{'default': './output',
                          ...
                          {'default': 1.0,
                           ...
                           'type': 'float'},
                          {'default': 1.0,
                           'description': 'Time interval between frames in '
                                          'seconds',
                           'name': 'time_interval_sec',
                           'type': 'float'},
                          {'default': 'right',
                           'description': "Direction of flow ('right', 'left', "
                                          "'up', 'down')",
                           'name': 'flow_direction',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to image sequence directory or '
                                          'video file',
                           'name': 'image_sequence_path',
                           'type': 'str'}]},
 {'description': 'Analyze CFSE-labeled cell samples to quantify cell division '
                 'and proliferation.',
  'name': 'analyze_cfse_cell_proliferation',
  'optional_parameters': [{'default': 'FL1-A',
                           'description': 'Name of the channel containing CFSE '
                                          'fluorescence data',
                           'name': 'cfse_channel',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Tuple of (min_fsc, max_fsc, '
                                          'min_ssc, max_ssc) for lymphocyte '
                                          'gating',
 ...
 {'description': 'Analyzes histological images of CNS lesions to quantify '
  ...
  'optional_parameters': [{'default': './output',
                           ...
                           'type': 'str'},
                          {'default': 'H&E',
                           'description': 'Type of histological stain used '
                                          '(options: "H&E", "LFB", "IHC")',
                           'name': 'stain_type',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Analyzes immunohistochemistry images to quantify protein '
  ...
  'optional_parameters': [{'default': 'Unknown',
                          ...
                          {'default': './ihc_results/',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the microscopy image of '
