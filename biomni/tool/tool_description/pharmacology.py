description = [{'description': 'Run DiffDock molecular docking using a protein PDB file and '
  ...
  'optional_parameters': [{'default': 0,
                           ...
                           'type': 'int'},
                          {'default': True,
                           'description': 'Whether to use GPU acceleration for '
                                          'docking',
                           'name': 'use_gpu',
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the protein PDB file for '
                                          'docking',
                           'name': 'pdb_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'SMILES string representation of the '
                                          'ligand molecule',
                           'name': 'smiles_string',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Local directory path where docking '
 ...
 {'description': 'Performs molecular docking using AutoDock Vina to predict '
  ...
  'optional_parameters': [{'default': 1,
                           'description': 'Number of CPU cores to use for '
                                          'docking',
                           'name': 'ncpu',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'List of SMILES strings representing '
                                          'small molecules to dock',
                           'name': 'smiles_list',
                           'type': 'List[str]'},
                          {'default': None,
                           'description': 'Path to the receptor protein '
                                          'structure PDB file',
                           'name': 'receptor_pdb_file',
                           'type': 'str'},
                          {'default': None,
                           'description': '3D coordinates [x, y, z] of the '
                                          'docking box center',
                           'name': 'box_center',
                           'type': 'List[float]'},
                          {'default': None,
                           'description': 'Dimensions [x, y, z] of the docking '
                                          'box',
                           'name': 'box_size',
                           'type': 'List[float]'}]},
 {'description': 'Runs AutoSite on a PDB file to identify potential binding '
  ...
  'optional_parameters': [{'default': 1.0,
                           'description': 'Grid spacing parameter for AutoSite '
                                          'calculation',
                           'name': 'spacing',
                           'type': 'float'}],
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Directory where AutoSite results '
                                          'will be saved',
                           'name': 'output_dir',
                           'type': 'str'}]},
 {'description': 'Computes TxGNN model predictions for drug repurposing and '
  ...
  'optional_parameters': [{'default': 5,
                           'description': 'The number of top drug predictions '
                                          'to return',
                           'name': 'k',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'The name of the disease for which '
                                          'to retrieve drug predictions',
                           'name': 'disease_name',
                           'type': 'str'}]},
 {'description': 'Predicts ADMET (Absorption, Distribution, Metabolism, '
  ...
  'optional_parameters': [{'default': 'MPNN',
                           'description': 'Type of model to use for ADMET '
                                          "prediction (options: 'MPNN', 'CNN', "
                                          "'Morgan')",
                           'name': 'ADMET_model_type',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'List of SMILES strings representing '
                                          'chemical compounds to analyze',
                           'name': 'smiles_list',
                           'type': 'List[str]'}]},
 {'description': 'Predicts binding affinity between small molecules and a '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'List[str]'},
                          {'default': None,
                           'description': 'Protein sequence in amino acid '
                                          'format',
                           'name': 'amino_acid_sequence',
                           'type': 'str'}]},
 {'description': 'Analyzes the stability of pharmaceutical formulations under '
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'List[dict]'},
                          {'default': None,
                           'description': 'List of time points in days to '
                                          'evaluate stability',
                           'name': 'time_points',
                           'type': 'List[int]'}]},
 {'description': 'Generates a detailed protocol for performing a 3D '
  ...
  'optional_parameters': [{'default': 21,
                           'description': 'Total duration of the culture '
                                          'period in days',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'dict'},
                          {'default': None,
                           'description': 'List of compounds to test, each '
                                          "with 'name', 'concentration', and "
                                          "'vehicle' keys",
                           'name': 'test_compounds',
                           'type': 'list of dict'}]},
 {'description': 'Grade and monitor adverse events in animal studies using the '
                 'VCOG-CTCAE standard.',
 ...
 {'description': 'Analyze biodistribution and pharmacokinetic profile of '
  ...
  'optional_parameters': [],
  'required_parameters': [{'default': None,
                           'description': 'Time points (hours) at which '
 ...
 {'description': 'Estimate radiation absorbed doses to tumor and normal organs '
  ...
  'optional_parameters': [{'default': 'dosimetry_results.csv',
                           'description': 'Filename to save the dosimetry '
                                          'results',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Perform a Methylome-wide Association Study (MWAS) to '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 'significant_cpg_sites.csv',
                           'description': 'Filename to save significant CpG '
                                          'sites.',
                           'name': 'output_file',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'str'}]},
 {'description': 'Calculate key physicochemical properties of a drug candidate '
                 'molecule.',
  'name': 'calculate_physicochemical_properties',
  'optional_parameters': [],
  'required_parameters': [{'default': None,
                           'description': 'The molecular structure in SMILES '
                                          'format',
                           'name': 'smiles_string',
                           'type': 'str'}]},
 {'description': 'Analyze tumor growth inhibition in xenograft models across '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Name of the column containing time '
                                          'points',
                           'name': 'time_column',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Name of the column containing tumor '
                                          'volume measurements',
                           'name': 'volume_column',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Name of the column containing '
