description = [{'description': 'Analyze DNA Damage Response (DDR) network alterations and '
                 'dependencies in cancer samples.',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to gene expression data file '
                                          '(CSV format with genes as rows, '
                                          'samples as columns)',
                          ...
                          {'default': None,
                           ...
                           'type': 'str'}]},
 {'description': 'Analyze flow cytometry data to quantify senescent and '
 ...
 {'description': 'Detects and annotates somatic mutations in tumor samples '
  ...
  'optional_parameters': [{'default': 'GRCh38.105',
                           'description': 'SnpEff database to use for '
                                          'annotation',
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the matched normal sample '
                                          'BAM file',
                           'name': 'normal_bam',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Detects and characterizes structural variations (SVs) in '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'Path to the COSMIC database for '
                                          'cancer annotation',
                           'name': 'cosmic_db_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the ClinVar database for '
                                          'clinical annotation',
                           'name': 'clinvar_db_path',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the aligned sequencing data '
                                          'in BAM format',
                           'name': 'bam_file_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the reference genome in '
                                          'FASTA format',
 ...
 {'description': 'Performs Non-negative Matrix Factorization (NMF) on gene '
  ...
  'optional_parameters': [{'default': 10,
                           'description': 'Number of metagenes (components) to '
                                          'extract.',
                           'name': 'n_components',
                           'type': 'int'},
                          {'default': True,
                           'description': 'Whether to normalize the expression '
                                          'data before applying NMF.',
                           'name': 'normalize',
                           'type': 'bool'},
                          {'default': 'nmf_results',
