description = [{'description': 'Fetches supplementary information for a paper given its DOI '
  ...
  'optional_parameters': [{'default': 'supplementary_info',
                           'description': 'Directory to save supplementary '
                                          'files',
                           'name': 'output_dir',
                           'type': 'str'}],
 ...
 {'description': 'Query arXiv for papers based on the provided search query.',
  ...
  'optional_parameters': [{'default': 10,
                           'description': 'The maximum number of papers to '
                                          'retrieve.',
                           'name': 'max_papers',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Search using Google search and return formatted results.',
  ...
  'optional_parameters': [{'default': 3,
                          ...
                          {'default': 'en',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'The search query (e.g., "protocol '
                                          'text or search question")',
                           'name': 'query',
                           'type': 'str'}]},
