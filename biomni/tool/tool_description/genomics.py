description = [{'description': 'Annotate cell types based on gene markers and transferred '
  ...
  'optional_parameters': [{'default': 'leiden',
                           'description': 'Clustering method to use for cell '
                                          'type annotation',
                           'name': 'cluster',
                           'type': 'str'},
                          {'default': 'claude-3-5-sonnet-20241022',
                           'description': 'Language model instance for cell '
                                          'type prediction',
                           'name': 'llm',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Transferred cell type composition '
                                          'for each cluster',
                           'name': 'composition',
                           'type': 'pd.DataFrame'},
  ...
  'required_parameters': [{'default': None,
                           'description': 'Name of the AnnData file containing '
                                          'scRNA-seq data',
                           'name': 'adata_filename',
                           'type': 'str'},
                          {'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Information about the scRNA-seq '
                                          'data (e.g., "homo sapiens, brain '
                                          'tissue, normal")',
                           'name': 'data_info',
                           'type': 'str'}]},
 {'description': 'Create scVI and scANVI embeddings for single-cell RNA-seq '
  ...
  'optional_parameters': [],
  'required_parameters': [{'default': None,
                           'description': 'Filename of the AnnData object to '
                                          'load',
                           'name': 'adata_filename',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Column name in adata.obs for batch '
                                          'information',
                           'name': 'batch_key',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Column name in adata.obs for cell '
                                          'type labels',
                           'name': 'label_key',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Directory path where the AnnData '
                                          'file is located and where output '
                                          'will be saved',
                           'name': 'data_dir',
                           'type': 'str'}]},
 {'description': 'Performs batch integration on single-cell RNA-seq data using '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Column name in adata.obs that '
                                          'defines the batch variable for '
                                          'integration',
                           'name': 'batch_key',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Directory path where the input file '
                                          'is located and output will be saved',
                           'name': 'data_dir',
                           'type': 'str'}]},
 {'description': 'Generate UCE embeddings for single-cell RNA-seq data and map '
  ...
  'optional_parameters': [{'default': '/dfs/project/bioagentos/data/singlecell/',
                           'description': 'Root directory for single-cell data '
                                          'storage',
                           'name': 'DATA_ROOT',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Custom command line arguments to '
                                          'pass to the UCE script',
                           'name': 'custom_args',
                           'type': 'List[str]'}],
  'required_parameters': [{'default': None,
                           'description': 'Filename of the AnnData object to '
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Directory where the input data is '
                                          'stored and output will be saved',
                           'name': 'data_dir',
                           'type': 'str'}]},
 {'description': 'Map cell embeddings from the input dataset to the Integrated '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Directory containing the AnnData '
                                          'file',
                           'name': 'data_dir',
                           'type': 'str'}]},
 {'description': 'Given a gene name, fetch RNA-seq expression data showing the '
  ...
  'optional_parameters': [{'default': 10,
                           ...
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'The gene name for which RNA-seq '
                                          'data is being fetched',
                           'name': 'gene_name',
                           'type': 'str'}]},
 {'description': 'Returns a list of supported databases for gene set '
                 'enrichment analysis.',
 ...
 {'description': 'Perform enrichment analysis for a list of genes, with '
  ...
  'optional_parameters': [{'default': 10,
                           ...
                           'type': 'int'},
                          {'default': 'ontology',
                           'description': 'Database to use for enrichment '
                                          'analysis (e.g., pathway, '
                                          'transcription, ontology)',
                           'name': 'database',
                           'type': 'str'},
                          {'default': None,
                           'description': 'List of background genes to use for '
                                          'enrichment analysis',
                           'name': 'background_list',
                           'type': 'list'},
                          {'default': False,
                           'description': 'Generate a bar plot of the top K '
                                          'enrichment results',
                           'name': 'plot',
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Analyze chromatin interactions from Hi-C data to identify '
  ...
  'optional_parameters': [{'default': './output',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the Hi-C data file (.cool '
                                          'or .hic format)',
                           'name': 'hic_file_path',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Perform comparative genomics and haplotype analysis on '
  ...
  'optional_parameters': [{'default': './output',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Paths to FASTA files containing '
                                          'whole-genome sequences to be '
                                          'analyzed',
 ...
 {'description': 'Perform ChIP-seq peak calling using MACS2 to identify '
  ...
  'optional_parameters': [{'default': 'macs2_output',
                           'description': 'Prefix for output files',
                           'name': 'output_name',
                           'type': 'str'},
                          {'default': 'hs',
                           'description': 'Effective genome size shorthand: '
                                          "'hs' for human, 'mm' for mouse, "
                                          'etc.',
                           'name': 'genome_size',
                           'type': 'str'},
                          {'default': 0.05,
                           'description': 'q-value (minimum FDR) cutoff for '
                                          'peak calling',
                           'name': 'q_value',
                           'type': 'float'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the ChIP-seq read data file '
                                          '(BAM, BED, or other supported '
                                          'format)',
                           'name': 'chip_seq_file',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the control/input data file '
                                          '(BAM, BED, or other supported '
                                          'format)',
                           'name': 'control_file',
                           'type': 'str'}]},
 {'description': 'Find DNA sequence motifs enriched in genomic regions using '
                 'the HOMER motif discovery software.',
  'name': 'find_enriched_motifs_with_homer',
  'optional_parameters': [{'default': 'hg38',
                           'description': 'Reference genome for sequence '
                                          'extraction',
                           'name': 'genome',
                           'type': 'str'},
                          {'default': None,
                           ...
                           'type': 'str'},
                          {'default': '8,10,12',
                           'description': 'Comma-separated list of motif '
                                          'lengths to discover',
                           'name': 'motif_length',
                           'type': 'str'},
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'peak_file',
                           'type': 'str'}]},
 {'description': 'Analyze overlaps between two or more sets of genomic '
                 'regions.',
  'name': 'analyze_genomic_region_overlap',
  'optional_parameters': [{'default': 'overlap_analysis',
                           'description': 'Prefix for output files',
                           'name': 'output_prefix',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
