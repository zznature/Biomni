description = [{'description': 'Analyze cell migration metrics from time-lapse microscopy '
                 'images.',
  'name': 'analyze_cell_migration_metrics',
  'optional_parameters': [{'default': 1.0,
                           'description': 'Conversion factor from pixels to '
                                          'micrometers',
                           'name': 'pixel_size_um',
                           'type': 'float'},
                          {'default': 1.0,
                           ...
                           'type': 'float'},
                          {'default': 10,
                           'description': 'Minimum number of frames a cell '
                                          'must be tracked to be included in '
                                          'analysis',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to the directory containing '
                                          'time-lapse images or path to a '
 ...
 {'description': 'Simulates CRISPR-Cas9 genome editing process including guide '
  ...
  'required_parameters': [{'default': None,
                          ...
                          {'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Type of cell or tissue being edited '
                                          '(affects delivery efficiency and '
                                          'editing outcomes)',
 ...
 {'description': 'Analyze calcium imaging data to quantify neuronal activity '
  ...
  'optional_parameters': [{'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the time-series stack of '
                                          'fluorescence microscopy images '
                                          '(TIFF format)',
                           'name': 'image_stack_path',
                           'type': 'str'}]},
 {'description': 'Analyzes in vitro drug release kinetics from biomaterial '
                 'formulations.',
  'name': 'analyze_in_vitro_drug_release_kinetics',
  'optional_parameters': [{'default': 'Drug',
                          ...
                          {'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Time points at which drug '
                                          'concentrations were measured (in '
                                          'hours)',
                           'name': 'time_points',
                           'type': 'List[float] or numpy.ndarray'},
                          {'default': None,
                           'description': 'Measured drug concentration at each '
                                          'time point',
                           'name': 'concentration_data',
                           'type': 'List[float] or numpy.ndarray'}]},
 {'description': 'Quantifies morphological properties of myofibers in '
                 'microscopy images of tissue sections.',
  'name': 'analyze_myofiber_morphology',
  'optional_parameters': [{'default': 2,
                           'description': 'Channel index containing nuclei '
                                          'staining (DAPI, Hoechst, etc.)',
                           'name': 'nuclei_channel',
                           'type': 'int'},
                          {'default': 1,
                           'description': 'Channel index containing myofiber '
                                          'staining (α-Actinin, etc.)',
                           'name': 'myofiber_channel',
                           'type': 'int'},
                          {'default': 'otsu',
                           'description': "Method for thresholding ('otsu', "
                                          "'adaptive', or 'manual')",
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'image_path',
                           'type': 'str'}]},
 {'description': 'Model neural activity trajectories and decode behavioral '
                 'variables.',
  'name': 'decode_behavior_from_neural_trajectories',
  'optional_parameters': [{'default': 10,
                           'description': 'Number of principal components to '
                          ...
                          {'default': './',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Neural spiking activity data, shape '
                                          '(n_timepoints, n_neurons)',
                           'name': 'neural_data',
                           'type': 'numpy.ndarray'},
                          {'default': None,
                           'description': 'Behavioral data, shape '
                                          '(n_timepoints, '
                                          'n_behavioral_variables)',
                           'name': 'behavioral_data',
                           'type': 'numpy.ndarray'}]},
 {'description': 'Simulate a whole-cell model represented as a system of '
  ...
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'callable'},
                          {'default': '(0, 100)',
                           'description': 'Tuple of (start_time, end_time) for '
                                          'the simulation.',
                           'name': 'time_span',
                           'type': 'tuple'},
                          {'default': 1000,
                           ...
                           'type': 'int'},
                          {'default': "'LSODA'",
                           'description': 'Numerical integration method to use '
                                          "(e.g., 'RK45', 'LSODA', 'BDF').",
                           'name': 'method',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
