description = [{'description': 'Query the UniProt REST API using either natural language or '
                 'a direct endpoint.',
  'name': 'query_uniprot',
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Anthropic API key. If None, will '
                                          'use ANTHROPIC_API_KEY env variable',
                           'name': 'api_key',
                           'type': 'str'},
                          {'default': 'claude-3-5-haiku-20241022',
                           'description': 'Anthropic model to use for natural '
                                          'language processing',
                           'name': 'model',
                           'type': 'str'},
                          {'default': 5,
  ...
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about '
                                          'proteins (e.g., "Find information '
                                          'about human insulin")',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the AlphaFold Database API for protein structure '
  ...
  'optional_parameters': [{'default': 'prediction',
                           'description': 'Specific AlphaFold API endpoint to '
                                          'query: "prediction", "summary", or '
                                          '"annotations"',
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Specific residue range in format '
                                          '"start-end" (e.g., "1-100")',
                           'name': 'residue_range',
                           'type': 'str'},
                          {'default': False,
                          ...
                          {'default': None,
                           ...
                           'type': 'str'},
                          {'default': 'pdb',
                           'description': 'Format of the structure file to '
                                          'download - "pdb" or "cif"',
                           'name': 'file_format',
                           'type': 'str'},
                          {'default': 'v4',
                           'description': 'AlphaFold model version - "v4" '
                                          '(latest) or "v3", "v2", "v1"',
                           'name': 'model_version',
                           'type': 'str'},
                          {'default': 1,
                           'description': 'Model number (1-5, with 1 being the '
 ...
 {'description': 'Query the InterPro REST API using natural language or a '
  ...
  'name': 'query_interpro',
  'optional_parameters': [{'default': None,
                           'description': 'Direct endpoint path or full URL '
                                          "(e.g., '/entry/interpro/IPR023411')",
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Anthropic API key. If None, will '
 ...
 {'description': 'Query the RCSB PDB database using natural language or a '
  ...
  'name': 'query_pdb',
  'optional_parameters': [{'default': None,
                           'description': 'Direct structured query in RCSB '
                                          'Search API format (overrides '
                                          'prompt)',
                           'name': 'query',
                           'type': 'dict'},
                          {'default': None,
 ...
 {'description': 'Retrieve detailed data and/or download files for PDB '
  ...
  'optional_parameters': [{'default': 'entry',
                           'description': "Type of results: 'entry', "
                                          "'assembly', 'polymer_entity', etc.",
                           'name': 'return_type',
                           'type': 'str'},
                          {'default': False,
                           'description': 'Whether to download PDB structure '
                                          'files',
                           'name': 'download',
                           'type': 'bool'},
                          {'default': None,
                           'description': 'List of specific attributes to '
                                          'retrieve',
                           'name': 'attributes',
                           'type': 'List[str]'}],
  'required_parameters': [{'default': None,
 ...
 {'description': 'Take a natural language prompt and convert it to a '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 'claude-3-5-haiku-20241022',
                           ...
                           'type': 'str'},
                          {'default': True,
                           'description': 'Whether to return detailed API '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the STRING protein interaction database using natural '
                 'language or direct endpoint.',
  'name': 'query_stringdb',
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 'claude-3-5-haiku-20241022',
                           ...
                           'type': 'str'},
                          {'default': False,
                           'description': 'Whether to download image results '
                                          '(for image endpoints)',
                           'name': 'download_image',
                           'type': 'bool'},
                          {'default': None,
 ...
 {'description': 'Query the IUCN Red List API using natural language or a '
  ...
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'API endpoint name (e.g., '
                                          '"species/id/12392") or full URL',
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Anthropic API key. If None, will '
                          ...
                          {'default': 'claude-3-5-haiku-20241022',
                           ...
                           'type': 'str'},
                          {'default': True,
                           'description': 'Whether to return detailed query '
                                          'information or just formatted '
                                          'results',
                           'name': 'verbose',
                           'type': 'bool'}],
  'required_parameters': [{'default': '',
                           'description': 'IUCN API token - required for all '
                                          'queries',
                           'name': 'token',
                           'type': 'str'}]},
 {'description': 'Query the Paleobiology Database (PBDB) API using natural '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about fossil '
                                          'records',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the JASPAR REST API using natural language or a direct '
  ...
  'name': 'query_jaspar',
  'optional_parameters': [{'default': None,
                           'description': 'API endpoint path (e.g., '
                                          "'/matrix/MA0002.2/') or full URL",
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Anthropic API key. If None, will '
 ...
 {'description': 'Query the World Register of Marine Species (WoRMS) REST API '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about marine '
                                          'species',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the cBioPortal REST API using natural language or a '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about cancer '
                                          'genomics data',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Take a natural language prompt and convert it to a '
                 'structured ClinVar query.',
  'name': 'query_clinvar',
  'optional_parameters': [{'default': None,
                           'description': 'Direct search term to use with the '
                                          'ClinVar API',
                           'name': 'search_term',
                           'type': 'str'},
                          {'default': None,
  ...
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about '
                                          'genetic variants (e.g., "Find '
                                          'pathogenic BRCA1 variants")',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the NCBI Gene Expression Omnibus (GEO) using natural '
                 'language or a direct search term.',
  'name': 'query_geo',
  'optional_parameters': [{'default': None,
  ...
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about '
                                          'RNA-seq, microarray, or other '
                                          'expression data',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the NCBI dbSNP database using natural language or a '
                 'direct search term.',
  'name': 'query_dbsnp',
  'optional_parameters': [{'default': None,
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the UCSC Genome Browser API using natural language or '
                 'a direct endpoint.',
  'name': 'query_ucsc',
  'optional_parameters': [{'default': None,
                           'description': 'Full URL or endpoint specification '
 ...
 {'description': 'Query the Ensembl REST API using natural language or a '
  ...
  'name': 'query_ensembl',
  'optional_parameters': [{'default': None,
                           'description': 'Direct API endpoint to query (e.g., '
                                          '"lookup/symbol/human/BRCA2") or '
                                          'full URL',
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the OpenTargets Genetics API using natural language or '
                 'a direct GraphQL query.',
  ...
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about '
                                          'genetic targets and variants',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the OpenTargets Platform API using natural language or '
                 'a direct GraphQL query.',
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': False,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about drug '
                                          'targets, diseases, and mechanisms',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the GWAS Catalog API using natural language or a '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': 3,
                           ...
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about GWAS '
                                          'data',
                           'name': 'prompt',
                           'type': 'str'}]},
 ...
 {'description': 'Identifies a DNA sequence using NCBI BLAST with improved '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'The BLAST database to search '
                                          'against',
                           'name': 'database',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Query the Reactome database using natural language or a '
  ...
  'optional_parameters': [{'default': None,
                           ...
                           'type': 'str'},
                          {'default': False,
                           'description': 'Whether to download pathway '
                                          'diagrams',
                           'name': 'download',
                           'type': 'bool'},
                          {'default': None,
 ...
 {'description': 'Query the PRIDE (PRoteomics IDEntifications) database using '
  ...
  'required_parameters': [{'default': None,
                           ...
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the Guide to PHARMACOLOGY database (GtoPdb) using '
                 'natural language or a direct endpoint.',
  'name': 'query_gtopdb',
  'optional_parameters': [{'default': None,
                           'description': 'Full API endpoint to query (e.g., '
  ...
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about drug '
                                          'targets, ligands, and interactions',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Given genomic coordinates, retrieves information of '
  ...
  'optional_parameters': [{'default': 'GRCh38',
                           'description': 'Assembly of the genome, formatted '
                                          "like 'GRCh38'",
                           'name': 'assembly',
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Chromosome of the genomic region, '
                                          "formatted like 'chr12'",
                           'name': 'coord_chrom',
                           'type': 'str'},
                          {'default': None,
 ...
 {'description': 'Given a cCRE (Candidate cis-Regulatory Element), return the '
  ...
  'optional_parameters': [{'default': 10,
                           'description': 'Number of nearby genes to return, '
                                          'sorted by distance',
                           'name': 'k',
                           'type': 'int'}],
  'required_parameters': [{'default': None,
                           'description': 'ENCODE Accession ID of query cCRE, '
                                          'e.g., EH38E1516980',
                           'name': 'accession',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Assembly of the gene, e.g., '
                                          "'GRCh38'",
                           'name': 'assembly',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Chromosome of the gene, e.g., '
                                          "'chr12'",
                           'name': 'chromosome',
                           'type': 'str'}]},
 ...
 {'description': 'Query the Mouse Phenome Database (MPD) for mouse strain '
  ...
  'optional_parameters': [{'default': None,
                           'description': 'Full API endpoint to query (e.g., '
                                          "'https://phenomedoc.jax.org/MPD_API/strains')",
                           'name': 'endpoint',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Anthropic API key. If None, will '
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about mouse '
                                          'phenotypes, strains, or '
                                          'measurements',
                           'name': 'prompt',
                           'type': 'str'}]},
 {'description': 'Query the Electron Microscopy Data Bank (EMDB) for 3D '
  ...
  'optional_parameters': [{'default': None,
                          ...
                          {'default': True,
                           ...
                           'type': 'bool'}],
  'required_parameters': [{'default': None,
                           'description': 'Natural language query about EM '
