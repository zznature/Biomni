description = [{'description': 'Analyze aortic diameter and geometry from cardiovascular '
  ...
  'required_parameters': [{'default': None,
                           'description': 'Path to the cardiovascular imaging '
                                          'data (DICOM, JPG, PNG)',
                           'name': 'image_path',
                           'type': 'str'}]},
 {'description': 'Analyze luminescence-based ATP assay data to determine '
                 'intracellular ATP concentration.',
  'name': 'analyze_atp_luminescence_assay',
  'optional_parameters': [{'default': 'cell_count',
                           'description': 'Method used to normalize ATP '
                                          'values, either cell_count or '
                                          'protein_content',
 ...
 {'description': 'Analyze histological images of thrombus samples stained with '
  ...
  'optional_parameters': [{'default': './output',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the histological image of '
                                          'thrombus sample stained with H&E',
                           'name': 'image_path',
                           'type': 'str'}]},
 {'description': 'Analyzes intracellular calcium concentration using Rhod-2 '
  ...
  'optional_parameters': [{'default': './output',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the background image (no '
                                          'cells, just media)',
                           'name': 'background_image_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the control image (cells '
                                          'without calcium stimulus)',
                           'name': 'control_image_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Path to the sample image (cells '
                                          'with calcium stimulus)',
                           'name': 'sample_image_path',
                           'type': 'str'}]},
 {'description': 'Quantify the volume/density of immunofluorescence-labeled '
  ...
  'optional_parameters': [{'default': './output',
                          ...
                          {'default': 'otsu',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the immunofluorescence '
                                          'microscopy image file',
                           'name': 'image_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'Type of nerve fiber marker (e.g., '
                                          "'βIII-tubulin', 'SP', 'L1CAM')",
                           'name': 'marker_type',
                           'type': 'str'}]},
 {'description': 'Segment cells and quantify protein expression levels from '
                 'multichannel tissue images.',
  'name': 'segment_and_quantify_cells_in_multiplexed_images',
  'optional_parameters': [{'default': 0,
                           'description': 'Index of the nuclear marker channel '
                                          '(typically DAPI)',
                          ...
                          {'default': './output',
                           ...
                           'type': 'str'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the multichannel image file '
                                          '(tiff stack or similar format)',
                           'name': 'image_path',
                           'type': 'str'},
                          {'default': None,
                           'description': 'List of marker names corresponding '
                                          'to each channel in the image',
                           'name': 'markers_list',
                           'type': 'List[str]'}]},
 {'description': 'Analyze bone microarchitecture parameters from 3D micro-CT '
  ...
  'optional_parameters': [{'default': './results',
                           ...
                           'type': 'str'},
                          {'default': None,
                           'description': 'Threshold value for bone '
                                          "segmentation. If None, Otsu's "
                                          'method will be used',
                           'name': 'threshold_value',
                           'type': 'float'}],
  'required_parameters': [{'default': None,
                           'description': 'Path to the micro-CT scan data file '
                                          '(TIFF stack or similar 3D format)',
