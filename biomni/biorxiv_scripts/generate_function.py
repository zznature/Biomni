...
def main():
    ...
    parser.add_argument('--task', '-t', type=str, help='Task description (if not provided, will prompt for input)')
    parser.add_argument('--output-dir', '-o', type=str, default='generated_functions', 
    ...
    parser.add_argument('--model', '-m', type=str, default='claude-3-7-sonnet-latest',
    ...
    if args.filename:
        ...
        base_filename = sanitize_filename(function_name)
